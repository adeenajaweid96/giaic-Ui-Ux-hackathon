...
// const Productlisting = async({params}:{params:{product:string}}) => {
 

// const fetchApi = await fetch(`https://hackathon-apis.vercel.app/api/products/${params.product}`)
...
//           src={res.image} width={400} height={400}
//         />
...
const Productlisting = async ({ params }: { params: { product: string } }) => {
    ...
    try {
        ...
        const res = await sanityClient.fetch(query, { id: params.product });
        ...
        return (
            <section className="text-gray-400 bg-gray-900 body-font overflow-hidden">
                <div className="container px-5 py-24 mx-auto">
                    ...
                    <p className="leading-relaxed">Please try again later.</p>
                </div>
            </section>
        );
    }
